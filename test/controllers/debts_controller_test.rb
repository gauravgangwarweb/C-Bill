...
class DebtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create debt" do
    assert_difference("Debt.count") do
      post debts_url, params: { debt: { amount: @debt.amount, customer_id: @debt.customer_id, user_id: @debt.user_id } }
    end
  ...
  test "should update debt" do
    patch debt_url(@debt), params: { debt: { amount: @debt.amount, customer_id: @debt.customer_id, user_id: @debt.user_id } }
